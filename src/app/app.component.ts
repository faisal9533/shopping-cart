...
export class AppComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        this.cart.onAdding$.subscribe((product:any) => {
            this.toastr.success(`Product "${product.name ? product.name : (product.SkuName ? product.SkuName:"product")}" added to cart!`);
        });
        this.compare.onAdding$.subscribe((product:any) => {
            this.toastr.success(`Product "${product.name ? product.name : (product.SkuName ? product.SkuName:"product")}" added to compare!`);
        });
        this.wishlist.onAdding$.subscribe((product:any) => {
            this.toastr.success(`Product "${product.name ? product.name : (product.SkuName ? product.SkuName:"product")}" added to wish list!`);
        });
    }
}
